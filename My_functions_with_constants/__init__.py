...
def load_density_profile_from_excel(excel_path=r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Shared Folder\Density profile.xlsx",
    ...
    y_loc = date_group['relative depth to camera [m]']
    density = date_group['density [kg/m^3]']
...
def save_vector_field_as_image(filename, image_name, scaling_factor = 3300, vector_scale = 1/10, window_size = 32, width = 0.001, sphere_loc = None, to_print = False):
    a = np.loadtxt(filename)
    x, y, u, v, flags, mask = a[:, 0], a[:, 1], a[:, 2], a[:, 3], a[:, 4], a[:, 5]
    ...
    if sphere_loc is not None:
        ax.scatter(sphere_loc[0] / scaling_factor, (im.shape[0] - sphere_loc[1])/  scaling_factor, c = 'black', s=30)
...
def extract_data_from_excel(file_path = r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Shared Folder\experiment notebook.xlsx",
...
def extract_data_from_excel_two_parameters(file_path =r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Python Thesis\Analysis\Dimensionless Numbers PTV.xlsx",
...
def sphere_type_to_data(key : str = 'P1'):
    options = {'P1': {'rho': 1134, 'diameter': 9.525 / 1000, 'Material': 'Nylon'},
        'P2': {'rho': 1110, 'diameter': 10 / 1000, 'Material': 'Nylon'},
        'P3': {'rho': 1240, 'diameter': 9.7 / 1000, 'Material': 'Cellulose Acetate'}}
    
    return options.get(key).get('diameter'), options.get(key).get('rho')

def load_data_for_demintionless_number(file_path = r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Shared Folder\experiment notebook.xlsx",
...
def plot_states(excel_path = r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Python Thesis\Analysis\Dimensionless Numbers PTV.xlsx",
...
def plot_states_with_Perceptron(excel_path=r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Python Thesis\Analysis\Dimensionless Numbers PTV.xlsx",
                                the_x_column='Upper Re',
                                the_y_column='Lower Re',
                                state_column='State',
                                title=None,
...
def add_calculated_density_coloum_to_excel(excel_path = r"C:\Users\Morten\OneDrive - mail.tau.ac.il\Thesis\Python Thesis\Analysis\Dimensionless Numbers PTV.xlsx"):
    r'''
    'Experiment Date',
    'Experiment number',
    'Record number',
